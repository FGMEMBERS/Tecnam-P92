...
######## Modified by Emmanuel BARANGER 02/2016    ########
##########################################################
var last_time = 0.0;
...
var avionics_bus = func(bus_volts) {
  ...
  if (props.globals.getNode("/instrumentation/nav/serviceable").getBoolValue()and props.globals.getNode("sim/p92/rmi-view").getBoolValue() ){
  ...
  if (props.globals.getNode("/instrumentation/adf/serviceable").getBoolValue()and props.globals.getNode("sim/p92/rmi-view").getBoolValue() ){
